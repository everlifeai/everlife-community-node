...
exports.create = function (api) {
  return nest('page.html.render', function channel (path) {
    ...
    var prepend = h('div.PageHeading', [ h('h1',{style:{color:'rgb(255, 0, 161)'}}, i18n('Everlife Chat!')),h('div.ever_balance',{style:{color:'rgb(255, 0, 161)',"font-size":"20px"}},'EVER Balance: '),h('span',{style:{'font-size': '20px',color:"green"}},(accbal.val))])
   
    return h('Scroller', { style: { overflow: 'auto' } }, [
      h('div.wrapper', [
      
        h('section.prepend', prepend),
        h('div.chat_wrap',{style:{
                "background": "#fff",
                "max-width": "500px",
                margin: "30px auto",
                "position": "relative",
        ...
        [h('div.container',{style:{
          ...
          [h('img',{
            ...
            style:{
             "margin": "8px",
             height: "30px",
            }}),h('span',{style:{'font-size': '20px',"color":"white"}},'Avatar Chat'),
          ],
          )]),h('div.chat_main',{
            id:'chat_main',classList:['chat_main'],
            style:{
                "height": "450px",
                "padding": "20px",
                "overflow": "auto",
...
function showMsg(msg, from, addl, isLocalStoreMsg) {
    ...
    let msgs = document.getElementById("chat_main");
