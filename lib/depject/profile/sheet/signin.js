...
exports.create = function (api) {
  ...
  return nest('profile.sheet.signin', function () {
      ...
      function openWebcam(){
        ...
        takeSnapShot = function () {
          WebCamera.snap(function (data_uri) {
            ...
            if(snap_left == 0)dispUser='All done! Face login will activate on next startup. It is recommended to set a password as well!';
            showDialog({
              type: 'info',
    ...
    function removePassword(){
      var pass_loc = path.join(u.dataLoc(), "login_password.json")
