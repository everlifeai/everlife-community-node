  ...
  patchwork: {
    ...
    page: {
      html: {
        render: {
          ...
          chat:require('./page/html/render/chat.js'),
          ...
          wallet: require('./page/html/render/wallet.js'),
          jobs: require('./page/html/render/jobs.js'),
          skills: require('./page/html/render/skills.js'),
          kb: require('./page/html/render/kb.js'),
    ...
    profile: {
      ...
      sheet: {
        ...
        signin: require('./profile/sheet/signin.js')
      }
    },
    progress: {
      html: {
    ...
    wallet: {
      handler: require('./wallet/handler.js'),
      sheet:{ 
        getSecret: require('./wallet/sheet/getSecret.js')
      },
      
    },
    pwd: {
      savepwd: require('./pwd/savepwd.js')
    },
    skills: require('./skills/skills.js'),
    kb: {
      kbeditor: require('./kb/kbeditor.js'),
    },
  }
}
