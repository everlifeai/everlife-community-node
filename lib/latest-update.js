...
module.exports = function () {
  ...
  var req = https.get({
    host: 'api.github.com',
    path: '/repos/everlifeai/everlife-node-releases/releases/latest',
    headers: {
      'user-agent': `Everlife v${version}`
    }
  }, function (res) {
  ...
  req.on('error', function (error) {
    console.log('error trying to reach github to check for latest everlife version: ', error)
  })
