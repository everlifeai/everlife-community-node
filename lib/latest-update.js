...
module.exports = function () {
  ...
  const checkForUpdate = () => {
    ...
    https.get({
      host: 'api.github.com',
      path: '/repos/everlifeai/everlife-community-node/releases/latest',
      headers: {
        'user-agent': `Everlife Explorer v${version}`
      }
    }, function (res) {
      ...
      console.log('error trying to reach github to check for latest everlife explorer version: ', error)
    })
  }
  ...
  // Everlife Explorer running in the background all the time and they should get
